...
namespace MaisonDesLigues
{
    internal abstract class Utilitaire
    {
        ...
        /// <summary>
        /// méthode permettant de github
        /// une combobox à partir d'une source de données
        /// </summary>
        /// <param name="UneConnexion">L'objet connexion à utiliser pour la connexion à la BD</param>
        ...
        /// <summary>
        /// Surcharge de la méthode remplir combobox pour passer un parametre pour la clause where de la vue
        /// </summary>
        /// </summary>
        /// <param name="UneConnexion">L'objet connexion à utiliser pour la connexion à la BD</param>
        /// <param name="UneCombo"> La combobox que l'on doit remplir</param>
        /// <param name="UneSource">Le nom de la source de données qui va fournir les données. Il s'agit en fait d'une vue de type
        /// VXXXXOn ou XXXX représente le nom de la tabl à partir de laquelle la vue est créée. n représente un numéro de séquence</param>
        /// <param name="valeur du Parametre">Parametre pour la clause where</param>
        /// <param name="NomParametre">Nom du parametre en clause where</param>
        public static void RemplirComboBox(Bdd UneConnexion, ComboBox UneCombo, String UneSource, String Parametre, String NomParametre)
        {

            UneCombo.DataSource = UneConnexion.ObtenirDonnesOracle(UneSource,Parametre,NomParametre);
            UneCombo.DisplayMember = "libelle";
            UneCombo.ValueMember = "id";
        }
        /// <summary>
